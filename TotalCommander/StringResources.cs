...
namespace TotalCommander
{
    ...
    public static class StringResources
    {
        ...
        private static void InitializeResources()
        {
            ...
            koResources["CreateNewFolder"] = "새 폴더 만들기";
            koResources["FolderName"] = "폴더 이름:";
            koResources["FolderExists"] = "같은 이름의 폴더가 존재합니다";
            ...
            koResources["FolderAlreadyExists"] = "'{0}' 폴더가 존재합니다";
            koResources["FileAlreadyExists"] = "'{0}' 파일이 존재합니다";
            ...
            koResources["FileNameTooLong"] = "파일 이름이 시스템에서 정의한 최대 길이를 초과합니다";
            koResources["InvalidName"] = "유효하지 않은 이름";
            koResources["PermissionDenied"] = "이 파일이나 폴더에 대한 권한이 충분하지 않습니다.";
            koResources["InvalidFileName"] = "유효하지 않은 파일 이름";
            koResources["ReadOnlyParentDirectory"] = "생성할 파일의 상위 디렉토리가 읽기 전용입니다";
            ...
            koResources["F5KeySettingBeforeSave"] = "저장전 F5 키 설정: 액션={0}";
            koResources["F5KeySettingVerification"] = "저장된 F5 키 설정 확인: 액션={0}";
            koResources["SettingsSaveConfirmation"] = "설정 저장 확인";
            koResources["SettingsVerificationError"] = "설정 검증 오류";
            koResources["SavedSettingsVerificationError"] = "저장된 설정 파일 검증 오류: {0}";
            ...
            koResources["NullSettingsReturned"] = "설정이 로드되었지만 null 값이 반환되었습니다";
            ...
            // Form_TotalCommander
            koResources["BuildDateTime"] = "빌드 일시: {0}";
